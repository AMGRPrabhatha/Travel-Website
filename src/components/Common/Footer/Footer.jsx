      ...
      <Container>
        <Row>
          ...
          <div className="d-flex align-items-center">
            <p className="pb-2"> Pitipana South,Homagama,Sri Lanka</p>
          </div>

          <div className="d-flex align-items-top my-2">
          <i className="bi bi-geo-alt me-3"></i>
          <a target="_blank" href="mailto:rasithprabatha90@gmail.com" className="d-block" >rasithprabatha90@gmail.com</a>
          </div>
          <div className="d-flex align-items-top ">
          <i className="bi bi-telephone me-3"></i>
          <a target="_blank" href="tel:0768429896" className="d-block" >0768429896</a>
          </div>
        ...
        <p className="text-light">   @ 2024. AMGR Rrabhatha All rights reserved </p> 
        </Col>
        </Row>
