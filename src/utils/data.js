// destinations img
import tour4 from "../assets/images/tour/see.png";
import tour5 from "../assets/images/tour/yala.png";
import tour6 from "../assets/images/tour/galle.png";
import tour7 from "../assets/images/tour/hikka.png";
import tour8 from "../assets/images/tour/arch.png";
import tour9 from "../assets/images/tour/dalanda.png";
import tour10 from "../assets/images/tour/adam.png";
import tour11 from "../assets/images/tour/ambu.png";

// populars img
import Anchorage from "../assets/images/popular/21.jpeg";
import Singapore from "../assets/images/popular/Mirissa.jpeg";
import Kiwiana from "../assets/images/popular/23.jpeg";
import Quito from "../assets/images/popular/24.jpeg";
import Cuzco from "../assets/images/popular/25.jpeg";
import Ushuaia from "../assets/images/popular/26.jpeg";
import Santiago from "../assets/images/popular/27.jpeg";
import Explorer from "../assets/images/popular/28.jpeg";
...
export const popularsData = [
  {
    ...
    image: Singapore,
    location: "Mirissa, Matara, Southern Province, Sri Lanka",
  ...
  },
  {
    ...
    title: "Riverston",
    image: Kiwiana,
    location: "Matale, Kandy distric, Central Province, Sri Lanka",
    category: ["Escorted Tour", "Tour & Cruise"],
  ...
  },
  {
    ...
    title: "Adam's Peak",
    image: Quito,
    location: "southwestern, northeast of Ratnapura, Sabaragamuwa province",
    category: ["Rail Tour", "Escorted Tou"],
    days: "2 days - 1 nights",
    price: 87,
    afterDiscount: 82,
    rating: 4,
  ...
  },
  {
    ...
    image: Anchorage,
    location: "W2W2+WGV, Polonnaruwa, Sri Lanka",
  ...
  },
  {
    ...
    image: Cuzco,
    location: "Galle Dutch Fort, Galle Town, Sri Lanka",
    category: ["Escorted Tou", "Tour & Cruise"],
    days: "1 days - 9 hours",
    price: 395,
    afterDiscount: 0,
    rating: 3,
  ...
  },
  {
    ...
    image: Ushuaia,
    location: "Nallur Kandaswamy Kovi, Jaffna, Sri Lanka",
    category: ["Escorted Tour", "Tour & Cruise"],
    days: "5 days - 4 nights",
    price: 93,
    afterDiscount: 0,
  ...
  },
  {
    ...
    image: Santiago,
    location: "Pidurangala Rock, Near Sigiriya, Matale, Sri Lanka",
    category: ["Escorted Tour", "Tour & Cruise"],
    days: "1 day - 1 night",
    price: 42,
    afterDiscount: 0,
